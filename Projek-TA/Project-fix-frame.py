...
#def ObjectDetection() :
    ...
    MODEL_NAME = '/home/pi/projek/tflite1/TFLITE' #Sample_TFLite_model
...
# Loop over every image and perform detection
    ...
    # Retrieve detection results
        ...
        Akurasi = Nilai_Tertinggi*100
        print('[INFO]  Akurasi : ',"{:.2f}".format(Akurasi), '%') 
    ...
    # All the results have been drawn on the image, now display the image 
        cv2.imshow('Label-Detector', cv2.resize(image,(750,450)))
